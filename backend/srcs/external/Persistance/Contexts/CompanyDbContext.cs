...
public sealed class CompanyDbContext : DbContext, IUnitOfWorkCompany {
	...
	public DbSet<CashProceed>       CashProceeds        { get; set; }
	...
	#region Product
        modelBuilder.Entity<Product>(builder => {
			...
			builder.Property(c => c.UnitOfMeasure)
    ...
    #endregion
	#region CashProceeds
		modelBuilder.Entity<CashProceed>(builder => {
	...
	private void SeedData(ModelBuilder builder) {
		builder.Entity<CashRegister>().HasData(
			new CashRegister { Id = Guid.NewGuid(), Name = "TL Kasası", CurrencyType = CurrencyTypeEnum.TL }
		);
	}
